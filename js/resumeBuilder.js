...
education.display = function()
{
	...
	//cycle through each online class
	for (var course in education.onlineCourses)
	{
		...
		$(".education-entry:last").append(formattedURL); // add the course URL	
	...
	if (education.schools.length)
	{
		for (var program in education.schools) //cycle through each University listed
		{
			...
			schoolURL = schoolURL.replace("%data%", education.schools[program].url);
